...
public class AIController : Controller
{
    ...
    private void Retreat()
    {
        if (target != null)
        {
            ...
            OnMovement?.Invoke(retreatDirection);
    ...
    private GameObject FindNearestEnemy()
    {
        ...
        foreach (BattleCharacter bc in bcs)
        {
            if (bc.gameObject != gameObject)
            {
                ...
                if (bc != null && enemyTeamComponent != null && enemyTeamComponent.teamIndex != battleCharacter.GetComponent<TeamComponent>().teamIndex)
                {
