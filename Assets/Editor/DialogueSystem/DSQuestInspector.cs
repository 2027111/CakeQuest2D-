...
[CustomEditor(typeof(QuestObject), true)]
public class DSQuestInspector : Editor
{
    ...
    private SerializedProperty QuestToggledProperty;
    private SerializedProperty NextQuestObjectProperty;
    ...
    protected void OnEnable()
    {
        ...
        questIdProperty = serializedObject.FindProperty("questId");
        questNameProperty = serializedObject.FindProperty("questName");
        QuestToggledProperty = serializedObject.FindProperty("QuestToggled");
        NextQuestObjectProperty = serializedObject.FindProperty("NextQuestObject");
    ...
    private void DrawQuestValueFields()
    {
        // Check if the target object is of type BattleCutscene
        DSInspectorUtility.DrawHeader("Quest Configuration");
        questIdProperty.DrawPropertyField();
        questNameProperty.DrawPropertyField();
        QuestToggledProperty.DrawPropertyField();
        NextQuestObjectProperty.DrawPropertyField();
        DSInspectorUtility.DrawSpace();
    }
    ...
    {
        DSInspectorUtility.DrawHeader("On Quest Success Dialogue");
